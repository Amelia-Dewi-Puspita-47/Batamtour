...
$user = [
  [
    "id" => 0,
    "nama" => "Nur Hidayad",
    "gambar" => "assets/images/tentangkami/profil.jpg",
    "jabatan" => "Hustler",
    ...
    <div class="container">
        ...
        <div class="container2">
                ...
                <div class="tentang-website">
                    <div class="pmv">
                    <h2>Pengenalan</h2>
                    <p>Batamtour adalah website yang berisikan informasi tempat wisata yang update pada kota Batam, Kepulauan Riau, Indonesia.</p>
                    </div>
                    <div class="pmv">
                    <h2>Menyediakan</h2>
