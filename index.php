...
<main>
    <div class="container">
        ...
        <!-- Bagian pengenalan wisata di Kota Batam -->        
        ...
        <div class="container2">
            ...
            <div class="albumwisata">
                ...
                <div class="photo-card">
                    <img src="<?= $data['gambar'] ?>" alt="<?= $data['nama'] ?>"> <!-- Gambar wisata -->
                    <div class="info">
                        <h2><?= $data['nama'] ?></h2> <!-- Nama wisata -->
                        <hr>
                        <p><?= $data['deskripsi'] ?></p> <!-- Deskripsi wisata -->
                        <div class="buttons">
                            <div class="btn-lokasi">
                                <button class="detail" onclick="window.location.href = '<?= htmlspecialchars($data['lokasiwisata']) ?>';">
                                    <span class="icon" style="background-image: url('assets/images/icon/Vector.png');"></span> <!-- Icon lokasi -->
                                    <?= $data['lokasi'] ?> <!-- Lokasi wisata -->
                                </button>
                            </div>
                            <div class="btn-detail">
                                <button class="detail" onclick="window.location.href='detailwisata.php?id=<?= $data['id'] ?>'">Detail</button> <!-- Tombol untuk melihat detail wisata -->
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="btn-selengkapnya">
                    <button class="detail">Selengkapnya</button> <!-- Tombol untuk melihat lebih banyak wisata -->
                </div>
            </div>
        </div>

        <!-- Bagian galeri wisata -->
        <div class="container3">
            <div class="con-left">
                ...
                <div class="btn-selengkapnyadetail">
                    ...
                    <button class="selengkapnya">Selengkapnya</button> <!-- Tombol untuk melihat galeri lebih lanjut -->
                </div>
            </div>
            <div class="con-right">
            <img src="assets/images/index/Wondeful.png" class="logo-image" style="height: auto; width:90%;"> <!-- Gambar terkait galeri -->
            </div>
        </div>
    </div>
    ...
    <!-- Bagian pembaruan wisata -->
    <div class="container4">
        <div class="con-right">
            <img src="assets/images/index/kuningan.png" class="logo-image" style="height: auto; width:90%;"> <!-- Gambar terkait pembaruan wisata -->
        </div>
        ...
        <div class="con-left">
            ...
            <div class="btn-selengkapnyadetail">
                <button class="selengkapnya">Selengkapnya</button> <!-- Tombol untuk melihat pembaruan lebih lanjut -->
            </div>
        </div>
    </div>
    ...
    <div class="container5">
        ...
        <div class="albumcard">
            ...
            <img src="<?= $data['gambar'] ?>" alt="<?= $data['nama'] ?>"> <!-- Gambar kategori wisata -->
            <div class="infocard">
                <br>
                <h3><?= $data['nama'] ?></h3> <!-- Nama kategori wisata -->
            </div>
            </button>
            <?php endforeach; ?>
        </div>
