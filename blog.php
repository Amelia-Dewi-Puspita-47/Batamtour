...
// Mendefinisikan array $blog yang berisi data blog
$blog = [ 
    [
        "id" => 0,
    ...
    <div class="container">
        <div class="container1">
            <div class="text-overlayWisata">
                <h1>Blog</h1> <!-- Judul halaman blog -->
            </div>
            <img src="assets/images/wisata/Mask.png" class="logo-image" style="height: auto; width:100%;"> <!-- Gambar header blog -->
            <br>
        </div>
        <div class="container1">
            <div class="blog">
                <h2>Apa yang terbaru hari ini?</h2> <!-- Sub-judul blog -->
            </div>
            <?php foreach ($blog as $data): ?> <!-- Memulai loop untuk menampilkan setiap blog -->
                <div class="blog-card">
                    <div class="img-blog">
                        <img src="<?= $data['gambar'] ?>" alt="Gambar Blog"> <!-- Gambar blog -->
                    </div>
                    <div class="content-blog">
                        <h2><?= $data['judul'] ?></h2> <!-- Judul blog -->
                        <p><?= $data['tanggal'] ?></p> <!-- Tanggal blog -->
                        <p><?= $data['deskripsi'] ?></p>  <!-- Deskripsi blog -->
                        <a href="<?= $data['url'] ?>" class="read-more">Selengkapnya</a> <!-- Link untuk membaca lebih lanjut -->
                    </div>
                </div>
            <?php endforeach; ?> <!-- Mengakhiri loop -->
        </div>
    </div>
</main>
